...
<div class="container">
    <div class="row">
        <div class="col-sm-2"><a class="btn btn-primary" href="{{ route('writergetyourarticles') }}">Back</a></div>
    ...
    <div class="row">
        ...
        <div class="col-sm-3  d-flex justify-content-end">
            <a class="btn btn-success m-1" href="{{ route('writeredityourarticleform',['aid'=>$article[0]['id']]) }}"><i class="bi bi-pencil-square"></i></a>
               ...
               <div class="modal fade" id="m{{ $article[0]['id'] }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="modal-content">
                    ...
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                        <form method="POST" action="{{ route('writerdeleteyourarticle',['aid'=>$article[0]['id']]) }}">
                            @csrf
                            @method('delete')
